...
public class KartaStudentiv
{
    public static void main(String[] args)
    {
        ...
        studentMap.put("Копач", "2007-03-20");
        studentMap.put("Романів", "2004-11-25");
        studentMap.put("Гунько", "2006-01-08");
        studentMap.put("Соджак", "2005-07-19");
        studentMap.put("Коваль", "2004-04-04");
        studentMap.put("Тригуба", "2005-12-30");
        studentMap.put("Цибаняк", "2006-02-10");
        studentMap.put("Диякон", "2005-06-17");
